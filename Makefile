...
templates/careers.html: s/careers.s.html s/jobs.s.html s/header.s.html s/footer.s.html
	cat s/header.s.html s/careers.s.html s/jobs.s.html s/footer.s.html > templates/careers.html
